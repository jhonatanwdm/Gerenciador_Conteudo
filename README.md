...
[![Versão](https://img.shields.io/badge/versão-1.0.0-blue.svg?style=for-the-badge)](https://github.com/jhonatanwdm/Gerenciador_Conteudo)
...
2. A janela nativa do Electron abre com tela de carregamento integrada.
...
```bash
npm run nova-versao -- 1.0.1 "Correções e melhorias de desempenho"
```
